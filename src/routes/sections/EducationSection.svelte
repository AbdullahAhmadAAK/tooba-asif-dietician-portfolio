...
<h1 class="font-bold md:text-[48px] sm:text-[38px] text-[28px] text-[#262626] mt-20 h-14 text-center" id="education">
  Education
</h1>
      ...
      <div class="flex flex-1 flex-col">
        ...
        <div class="flex  items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            />
            <p class="text-green-600 text-xs lg:text-base">{work.subheading}</p>
          </div>
          <div class="flex items-center gap-2">
            <img
              src={work.icon2}
              ...
              class="w-6 h-8"
            />
            <p class="text-green-600 text-xs lg:text-base">{work.subheading2}</p>
          </div>
        </div>
      </div>
